 ...
 * @author younes
 */
public class UpdateDeleteEquipment extends javax.swing.JFrame {

    /**
     * Creates new form UpdateDeleteEquipment
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update Delete Equipment ");
        ...
        jLabel5.setText("Equipment Price");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            PreparedStatement ps = con.prepareStatement("update equipment set name=?,quantity=?,price=? where id=?");
            ps.setString(1, name);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateDeleteEquipment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
