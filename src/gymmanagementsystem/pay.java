...
public class pay extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int a = JOptionPane.showConfirmDialog(null, "Do you really want to add payment", "Select", JOptionPane.YES_NO_OPTION);
        if (a == 0) {
            ...
            if(jTextField5.getText()==null){
                ...
                try {
                    Connection con = ConnectionProvider.getCon();
                    Statement st = con.createStatement();
                    st.executeUpdate("delete from pay where id='" + idmember + "'");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if (a == 0) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, " Payment Successfully Canceled");
                setVisible(false);
